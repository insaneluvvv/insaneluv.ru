...
const LinguaFlow = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/portfolio/design/LinguaFlow/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      <PortfolioTitle>
        ...
        <p className="section-title">/ Презентация LinguaFlow </p>
      </PortfolioTitle>      
      <PortfolioDesc className="default-font">Пет-прокет. Информационная презентация услуг онлайн-платформы для изучения иностранных языков — LinguaFlow.<br/><br/>
      "Учись говорить свободно"</PortfolioDesc>
      <ItemsList>
