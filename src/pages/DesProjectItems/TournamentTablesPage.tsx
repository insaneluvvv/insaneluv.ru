...
const TournamentTables = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/portfolio/design/TournamentTables/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      <PortfolioTitle>
        ...
        <p className="section-title">/ Турнирные таблицы</p>
      </PortfolioTitle>      
      <PortfolioDesc className="default-font">
      Здесь собраны турнирные таблицы, которые мне довелось создать в ходе своей деятельности.
      </PortfolioDesc>
      <ItemsList>
