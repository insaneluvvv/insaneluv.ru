...
const StudJob = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/portfolio/design/studjob/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      <PortfolioTitle>
        ...
        <p className="section-title">/ Поиск вакансий для студентов </p>
      </PortfolioTitle>      
      <PortfolioDesc className="default-font">
      Это интерфейс пет-проект, который создавался, как вариант дипломной работы. Вдохнавлен желанием студентов и преимущественно выпускников обрести свои первые офферы.<br/><br/>
      Проект стилизован под Университет "МИСИС". Его структура позволяет студентам быстро ориентироваться и на ходить вакансии, которые подходят именно им, блягодаря фильтрации по институтам.
      </PortfolioDesc>
      <ItemsList>
