...
const PersonalSite = () => {
  ...
  const images: Record<string, string> = import.meta.glob(
    "./../../assets/media/portfolio/development/personalsite/*.{jpg,png,webp}",
    {
      eager: true,
      import: "default",
      query: "?url",
  ...
  return (
    <HomeWrapper>
      <PortfolioTitle>
        <span className="section-title" onClick={() => navigate(-1)}>DEVELOPMENT PORTFOLIO </span>
        <p className="section-title">/ Личный сайт </p>
      </PortfolioTitle>      
      <PortfolioDesc className="default-font">
      Разработка личного сайта.<br/><br/>
      Стек технологий:<br/><br/>
      React | TypeScript | Styled Components | React Router Dom | firebase
      </PortfolioDesc>
      <ItemsList>
