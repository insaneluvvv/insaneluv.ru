			...
			<MainContainer>
				...
				<InfoContainer>
						...
						<ContainerElement>
								...
								<ContainerElementInfo>
									...
									<p className="default-font">Ключевые задачи:<br/>
										- Выполнял широкий спектр дизайн задач для клиентов в сферах соц. сетей, турниров, брендинга и др. Работал со статикой и интерфейсами.<br/>
										...
										· Создал и продвигал личный бренд, нарастив аудиторию в Discord 1500+ участников и Telegram 700+ подписчиков (в пике).<br/>
					...
					<AboutContainer>
						...
						Занимаюсь <span className="accent-font">графическим и UI/UX дизайном более 3-х лет</span>, совмещая фриланс-проекты с основной деятельностью. Имею подтвержденный опыт создания дизайна для киберспортивных команд, турниров и IT-компаний: от брендинга до интерфейсов. Понимаю бизнес задачи маркетинга и умею создавать дизайн, который решает их.<br/>
